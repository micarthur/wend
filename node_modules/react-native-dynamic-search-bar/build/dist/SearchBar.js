...
class SearchBar extends React.Component {
    ...
    renderTextInput = () => {
        ...
        return (<react_native_1.TextInput placeholderTextColor={_placeholderTextColor} {...this.props} onBlur={onBlur} onFocus={onFocus} ref={(ref) => (this.inputRef = ref)} style={[SearchBar_style_1._textInputStyle(darkMode), textInputStyle]} placeholder={placeholder}/>);
    };
    renderClearIcon = () => {
